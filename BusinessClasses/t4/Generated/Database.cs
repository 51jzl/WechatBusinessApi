...
namespace WB
{
	...
	public partial class WBDB : Database
	{
		...
		public WBDB(string connectionStringName) 
        ...
        public static WBDB GetInstance()
        {
			if (_instance!=null)
				return _instance;
		...
		[ThreadStatic] static WBDB _instance;
    ...
    public partial class bs_ProxyLevel : WBDB.Record<bs_ProxyLevel>  
    {
		...
		[Column] public long PurchaseAmount { get; set; }





		[Column] public long ReplenishmentAmount { get; set; }
